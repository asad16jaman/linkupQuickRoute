...
@section('pageside')
    @include('admin.layout.sidebar', ['page' => 'delivery'])
@endsection
        ...
        <div class="page-inner">
            ...
            <div class="card mb-1">
                <div class="card-header pt-1 pb-0">
                    <h4 class="text-center">Create Delivery Man</h4>
                </div>
                            ...
                            <div class="col-md-8 col-12">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-9 col-12">
                                        ...
                                        @enderror" name="title" value="{{ old('title', optional($editCategory)->title) }}"
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header p-2">
                            <h5 class="card-title ">ALL Delivery Men</h5>
                        </div>
                        <div class="card-body">
                                                    ...
                                                    @forelse($allCategories as $category)
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="d-flex justify-content-center">
                                                                ...
                                                                <a href="{{  route('admin.delivery', ['id' => $category->id, 'page' => request()->query('page'), 'search' => request()->query('search')])  }}"
                                                                    class="btn btn-info p-1 me-1">
                                                                    <i class="fas fa-edit iconsize"></i>
                                                                </a>

                                                                <form
                                                                    action="{{ route('admin.delivery.delete', ['id' => $category->id]) }}"
                                                                    method="post">
                                                                    @csrf

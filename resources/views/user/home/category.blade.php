            ...
            @foreach ($categories as $category)
                ...
                <div class="service-single">
                    <div class="service-icon">
                        <img style="width:70px;color:orange"
                            src="{{ $category->img ? asset('storage') . '/' . $category->img : asset('assets/user/img/serviceIcon/courier.png')}}"
                            alt="fail to load">
                    </div>
                    <div class="service-content">
                        <h4><a type="p" style="font-weight: 300;margin-bottom:0px">{!! $category->name !!}</a></h4>
                        <hr>
                        {!! $category->long_description !!}
                        <a class="main-btn primary" href="{{ route('user.service', ['name' => $category->nav_name]) }}">
